...
<p>
  <a href="https://github.com/Akash/HireSky/releases/latest"><img src="https://img.shields.io/github/v/release/Akash/HireSky?style=for-the-badge&label=Latest&color=111111&labelColor=000000" alt="Latest release" /></a>
  <a href="https://github.com/Akash/HireSky/releases"><img src="https://img.shields.io/github/downloads/Akash/HireSky/total?style=for-the-badge&color=111111&labelColor=000000" alt="Downloads" /></a>
...
<a href="https://hiresky.akash.dev"><b>Website</b></a> &nbsp;|&nbsp;
...
| Platform | File | Notes |
|---|---|---|
| Windows | [Setup .exe](https://github.com/Akash/HireSky/releases/latest) | NSIS installer. Adds a Start Menu shortcut. |
| Linux (Debian or Ubuntu) | [.deb](https://github.com/Akash/HireSky/releases/latest) | Pulls system deps automatically (Python, ffmpeg, GTK). |
| Linux (universal) | [.AppImage](https://github.com/Akash/HireSky/releases/latest) | No install. Run `chmod +x` then launch. |

> **macOS:** there is no pre-built download. The app is unsigned and un-notarized, so macOS Gatekeeper blocks it as "damaged and can't be opened." Run HireSky from source instead — see [Quick start](#quick-start). It is a one-line `./setup.sh` once Node.js is installed.
...
The website at [hiresky.akash.dev](https://hiresky.akash.dev) detects your operating system and offers the right installer directly.
...
HireSky is under active development. The core is stable and improvements ship regularly.
...
- **setup.sh will not run.** Make sure you are in the project folder (`cd HireSky`) and that the script is executable (`chmod +x setup.sh`). On Windows, use Git Bash.
...
HireSky collects no data and sends no telemetry. Processing happens locally, and your session stays on your device. Requests to the AI provider are encrypted in transit.
...
Built by [Akash](https://akash.dev). If HireSky helped you, consider giving it a star ⭐
